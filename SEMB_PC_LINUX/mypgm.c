/**
Apresentação Geral do Algoritmo: Sobel Robert Cross - Algoritmo de detecção de bordas em imagens pgm.
...
* Instituto Federal de EducaÁ„o, CiÍncia e Tecnologia do Ceará - IFCE
